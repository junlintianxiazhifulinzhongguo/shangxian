<template>
  <div class="social-signup-container">
    ...
    <div class="sign-btn" @click="alipayHandleClick('alipay')">
      <span class="ali-svg-container"><svg-icon icon-class="alipay" class="icon"/></span> 支付宝
    </div>
...
export default {
  ...
  methods: {
    ...
    alipayHandleClick(thirdpart) {
      // this.$store.commit('SET_AUTH_TYPE', thirdpart)
      const url = loginByAlipay()
      console.log(url)
      openWindow(url.auth_url, thirdpart, 600, 600)
    },
